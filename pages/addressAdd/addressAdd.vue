<template>
	<view>
		<u-navbar title="添加收货地址" :is-back="true" :title-bold="true" title-color="#000000" class="shadow"></u-navbar>
		...
		<view class="bg-white-color px-20">
			...
			<u-button type="success" class="p-fixed left-0 right-0 bottom-0 u-m-b-45 mx-20" @click="submit">添加地址</u-button>
		</view>
